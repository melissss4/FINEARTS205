...
function setup() {
  ...
  let numStars = 100; // Number of stars to create initially
...
// Added a mouse pad funtion as well, so that when mouse is pressed, the randomised background will reset to another random spacing
